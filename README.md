...
Frontend & Full-Stack Developer · Software Engineering Student @ Telkom University Surabaya

I build responsive, clean web apps using **React.js**, **Next.js**, and **Laravel**.  
Currently finishing my final year — open to frontend & full-stack opportunities.

![Last Updated](https://img.shields.io/badge/Last%20Updated-02%20May%202026-8b949e?style=flat-square&labelColor=0d1117)
...
|---|---|---|
| **Disbox Web** | Discord-integrated file storage · React.js + Supabase + Tailwind CSS | [disbox-web.pages.dev](https://disbox-web.pages.dev) |
| **Ruang Santri** | Islamic boarding school management · Laravel + Blade + MySQL | [ruang-santri.com](https://ruang-santri.com) |
| **HRIS Dashboard** | HR performance monitoring · Laravel + Chart.js + MySQL | [GitHub](https://github.com/evftrya/hr_TelkomUniversity) |

---

📬 naufalalamsyah453@gmail.com · [LinkedIn](https://linkedin.com/in/naufal-gastiadirrijal-fawwaz-alamsyah-a34b43363)
